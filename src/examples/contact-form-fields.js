  ...
  },
  {
    ...
    tooltip: {
      render: (data) => (
        <OverlayTrigger
          overlay={
            <Tooltip id="phoneTooltip">US 10 digit phone number</Tooltip>
          }
          placement="top"
          delayShow={150}
          delayHide={150}
    ...
    validators: [
      ...
      {
        validate: (data) =>
          data.phone.length == 0 || regexValidators.phone.test(data.phone),
  ...
  },
  {
    ...
    validators: [
      ...
      },
      {
        ...
        validate: (data) =>
          data.email.length === 0 || regexValidators.email.test(data.email),
  ...
  },
  {
    ...
    validators: [
      ...
      },
      {
        validate: (d) =>
          d.email.length === 0 ||
          d.confirmEmail.length === 0 ||
          d.confirmEmail.toLowerCase() === d.email.toLowerCase(),
